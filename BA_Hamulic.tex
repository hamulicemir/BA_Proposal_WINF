...
The Machine Learning component is primarily used as a mechanism to detect and prioritize \emph{unknown} events.
...
This work therefore evaluates if an Machine Learning component and a rules-first hybrid strategy is able to improve automated classification and decision support compared to a rule-only method.
...
(iii) how to train and apply an Machine Learning classifier with confidence-based handling of \textit{Unknown} events.
...
\begin{enumerate}
    ...
    \item \textbf{Aggregation and Storage:} Aggregation of events over time windows and storing summaries like confidence statistics or affected entities inside MariaDB.
    \item \textbf{Evaluation:} Definition of a test protocol with two scenarios:
          \begin{itemize}
              \item \textit{Known-classes test (closed-set):} Evaluation of how well rule-based, Machine Learning-based, and hybrid approaches classify log events into the predefined error classes.
    ...
    \item \textbf{Comparison and Reporting:} Comparison of rule-based, Machine Learning-based, and hybrid approaches with metrics at two levels:
          \begin{enumerate}
          ...
          \end{enumerate}
          The novelty test reports \textit{Unknown-Recall} and \textit{False-Reject Rate}. The results are summarized and could be used for guidance on when rules, Machine Learning, or a hybrid approach is most suitable.
\end{enumerate}
...
This is expected to offer practiceable guidance on how to prioritize rule development, where Machine Learning adds operational value, or how this could be used for \textit{Unknown} cases as input for iterative refinement of the class catalogue and the rule base.
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X
        ...
        \midrule
        SRQ2: How do rule-based, Machine Learning-based, and hybrid approaches differ in measurable performance at log-line and time-window/incident level?                                                 &
        ...
        \midrule
        SRQ3: Which error classes are better addressed by deterministic rules and which benefit more from Machine Learning-based classification, and which class characteristics explain these differences? &
